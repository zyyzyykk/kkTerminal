...
- Add SSH Option and custom Command Code deletion function
...
- Command Code supports Get/Set to Session/Local Level variables
- Text editor adds intelligent prompts for Command Code native object `kkTerminal`
...
- Adapt to default fonts and optimize Command Code status display
...
- Add Command Code status information and optimize Command Code display

##### zyyzyykk/kkterminal:3.1.2

- The file editor supports code highlighting and intelligent prompts for common file types
- Add [Command Code](./CMDCODE.md) to enable quick access to functional modules and execution of specific operational processes
